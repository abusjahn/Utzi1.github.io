...
These alternatives may include writing program-code, something that at the fist sight appear to be a little inconvenient if you're used to clicking, copying, pasting etc.
Once you mastered the burden of "programming" data-analysis can be quite a pleasure.
To achieve the point of absolute pleasures any help is welcomed, especially things that simplify other things, speaking in R these simplifiers come as functions wrapped up inside packages.
...
We are aiming to popularize the usage of R (https://www.r-project.org) with scientists and engineers working on fields related to Biotechnologies.
